...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$simpan = mysqli_query($koneksi,"INSERT INTO kriteria (id_kriteria, kode_kriteria, nama, prioritas, bobot, ada_pilihan) VALUES ('', '$kode_kriteria', '$nama', '$prioritas', '', '$ada_pilihan')");
		if($simpan) {
