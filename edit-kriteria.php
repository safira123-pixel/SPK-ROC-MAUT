...
if(isset($_POST['submit'])){
	...
	if(!$prioritas) {
		$errors[] = 'prioritas kriteria tidak boleh kosong';
	}
	
	// Jika lolos validasi lakukan hal di bawah ini
	if(empty($errors)){
		
		$update = mysqli_query($koneksi,"UPDATE kriteria SET kode_kriteria = '$kode_kriteria', nama = '$nama', prioritas = '$prioritas', ada_pilihan = '$ada_pilihan' WHERE id_kriteria = '$id_kriteria'");
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="number" name="prioritas" value="<?php echo $d['prioritas']; ?>" required class="form-control"/>
				</div>
